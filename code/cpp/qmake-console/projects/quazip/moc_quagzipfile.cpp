...
#include "../../../src/xk/external/quazip/quazip/quagzipfile.h"
...
QT_INIT_METAOBJECT const QMetaObject QuaGzipFile::staticMetaObject = { {
    &QIODevice::staticMetaObject,
    qt_meta_stringdata_QuaGzipFile.data,
