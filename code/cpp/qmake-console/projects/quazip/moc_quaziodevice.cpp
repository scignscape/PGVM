...
#include "../../../src/xk/external/quazip/quazip/quaziodevice.h"
...
QT_INIT_METAOBJECT const QMetaObject QuaZIODevice::staticMetaObject = { {
    &QIODevice::staticMetaObject,
    qt_meta_stringdata_QuaZIODevice.data,
    qt_meta_data_QuaZIODevice,
    qt_static_metacall,
    nullptr,
    nullptr
} };
