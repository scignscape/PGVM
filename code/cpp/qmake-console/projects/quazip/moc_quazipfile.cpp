...
#include "../../../src/xk/external/quazip/quazip/quazipfile.h"
...
QT_INIT_METAOBJECT const QMetaObject QuaZipFile::staticMetaObject = { {
    &QIODevice::staticMetaObject,
    qt_meta_stringdata_QuaZipFile.data,
    qt_meta_data_QuaZipFile,
    qt_static_metacall,
    nullptr,
    nullptr
} };
