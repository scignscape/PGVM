...
public GateStatsPane(MainWindow* mw)
{
 ...
 cbShowParent = new QCheckBox(tr("Show % of parent"));
 cbShowTotal = new QCheckBox(tr("Show % of total"));
 bCopyCSV = new QPushButton(tr("Export to clipboard"));
...
static QString GateStatsPane::formatPerc(double d)
{
