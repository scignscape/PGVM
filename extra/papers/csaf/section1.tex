...
corpora (via \MdsX{}) and to create individual 
...
these archives could include machine-readable representations of 
...
application; articles discussing novel computer code might be read
...
\CsAF{} library).  Finally, \MOSAICSR{} presentations 
...
(in other words, the annotation ground is a fine-grained 
location-designation in the text).  Another 
...
publication texts and data sets, \CsAF{} introduces 
...
Such information is then used by \CsAF{} \PDF{} 
viewers to cross-reference publications 
and data sets according to a protocol which 
allows users to conveniently switch back and 
...
\phantomsection\label{ph:axf}  
(More information about \HTXN{} and annotations 
is provided in a separate LTS White Paper: 
\bhref{http://raw.githubusercontent.com/Mosaic-DigammaDB/CRCR/master/digamma/axf.pdf}.) 
}
