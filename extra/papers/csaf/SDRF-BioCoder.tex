...
setup (rather than the article text).}
...
to be construsted in an expressive manner, utilizing 
...
Insofar as protocol models can be tailored to different scientific fields,
...
programming elements (e.g. procedures, types, object member 
...
annotations, including the \Pandore{} ontology and \MiFlowCyt{} 
