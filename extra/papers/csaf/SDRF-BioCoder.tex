...
\ifnum\value{page}=18   %\pgfmathresult>0\relax
\put(47,62){
...
\section{Documenting Research Protocols: Making Beneficial Modifications of BioCoder}
...
and automate biology protocols so thay may be replicated in other 
...
systems spread across text, code, and data as much as is possible.  
