...
Investigations); (4) explicitly representing information encoded via file-names; 
(5) bundling raw data, meta-data, and (where possible) machine-readable 
article text into a single resource, which \SDRF{} calls a 
\q{Supplemental Archive;} and (6) annnotating the data sets to support 
