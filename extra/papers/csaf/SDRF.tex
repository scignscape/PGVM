...
\ifnum\value{page}=13   %\pgfmathresult>0\relax
\put(50,60){
...
\URL{} for the data set near the top of the research document; 
...
however, so as to pin the location of \SDRF{} meta-data, 
...
authors' research (and other research which is cited 
within new articles) is properly referenced, ensuring 
...
a brief overview of their data set if doing so is necessary 
...
finalized).  Consequently, when a data set links to its accociated 
...
keyword searches) for scholars to locate books and 
