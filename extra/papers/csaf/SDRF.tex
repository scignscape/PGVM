...
\geometry{left=.72in,top=.47in,right=.68in,bottom=1.2in} %margins
...
host software.  Digital Notebooks in this guise would be 
...
cross-application Digital Notebook could profitably 
be centered on hypergraph database theory.  In this manner a 
Digital Notebook protocol would be thematically related to 
\SDRF{}'s proposed protocol for remote database access, discussed next.}
