...
to browse through the articles so as to find downloadable 
links (see Figure~\ref{fig:s3}).  In short, piecing all 
...
By examining file names, it would be possible to construct a 
...
\begin{tikzpicture}
\node[inner sep=0pt] (bib) at (0,0)
    {\includegraphics[trim=4cm 1.5cm 4.5cm 2.5cm,clip,width=.8\textwidth]{./scrn/s3.png}};
\node [anchor=west,bottom color=fcBoxColor!80!red,top color=purple!70!blue, 
inner sep=3, shading angle=10, text width=4.5cm]
  (longnote) at (7.3, 0) {\vspace{-8pt}%  %{\color{rb!85!red}{
{\cframedboxx{0mm}{2pt}{\large\raggedright\textbf{Some data sets 
