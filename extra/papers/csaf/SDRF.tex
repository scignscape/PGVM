...
pertaining to the specific repository and hosting platform 
...
gravitate to using raw data which can be plugged 
...
accessing Hypergraph data.  Such a framework's value could 
