...
In order to work with a variety of different 
corpora, each with their own structures and 
protocol, \MdsX{} is built around a 
\q{Scientific Data Repository Model} 
(\SDRM{}) which is concretized 
separataly for each corpus or repository 
