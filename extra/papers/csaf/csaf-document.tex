...
and whatever persistent/serial/\GUI{} representations that 
...
as part of the \q{\lConceptsDB{} Application Framework} 
(\CsAF{}) which is oriented to scientific computing 
and software.  \lCsAF{} database instances 
...
which prioritizes deploying and 
...
\p{The \MdsX{} libraries include code for interoperating 
...
so that open-access \SDRM{} modules 
