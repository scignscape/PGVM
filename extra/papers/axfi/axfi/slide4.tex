...
image-annotation frameworks as encountered 
in different scientific disciplines is that, even 
while the semantic and geometric meaning of 
annotations varies across contexts, the HCI 
...
inner sep=2, text width=8cm]
  (longnote) at (4.7,8.8) {\vspace{-8pt} %  %{\color{rb!85!red}{
...
opacity=0.88, text opacity=1] (tools) at (9.8, 12.6) {Tools};

\colorarr{>=latex, ->}{fcBoxColor!60!black}
{0.8}{blGreen!30!red}{1}{1mm}{tools.north east}{14,15}
