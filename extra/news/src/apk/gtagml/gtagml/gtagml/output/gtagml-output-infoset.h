...
#ifndef GTAGML_OUTPUT_INFOSET__H
#define GTAGML_OUTPUT_INFOSET__H
...
class GTagML_Output_Infoset : public GTagML_Output_Base, private GTagML_Output_Event_Handler
{
...
public:
 ...
 GTagML_Output_Infoset(GTagML_Document& document);//, HTXN_Infoset_8b* infoset);
